...
<div class="jumbotron jumbotron-fluid bg-light website-intro">
	<div class="container">
		<p class="lead text-left">
			We work with small - large scale businesses, enterprenuers and corporate organizations to bring value to their work by building an Ecommerce platform which generates sales more easily and efficiently. Getting to know your ‘Brand’ is the most important task for us. Through this, we completey transform your website into an Ecommerce platform that defines your brand as well as engages and inspires visitors and puts your customers at the center of the overall experience.
		</p>
...
<div class="jumbotron jumbotron-fluid bg-white">
	<div class="container ecommerce-second-div">
		<div class="row text-left">
			<div class="col-sm-6">
				<h3 class="font-weight-bold">
					Beautifully curated E-commerce website to boost and maximize your sales and growth
				</h3>
				<hr>
				<p>					
					Our professional team makes sure that your customers gets the best shopping experience possible and engage them throguout the whole process. We learn about your brand and create beautiful layouts and site contents which impacts the overall user experience which eventually leads to growth in your sales.   
				</p>
			</div>
...
<div class="jumbotron jumbotron-fluid bg-dark text-white">
	<div class="container booking-consultation-div">
		<div class="row text-center">
			<div class="col-sm-12">				
				<h3 class="font-weight-bold">
					Looking to step up your business on the Internet? Create an E-commerce platform today.
				</h3>
			</div>
			<div class="col-sm-12">
				<a href="" class = "btn btn-outline-default engagementBtn" title="">Book a free consultation</a>
...
<div class="jumbotron jumbotron-fluid bg-light text-center">
	...
	<div class="container ecommerce-application-container">
		<h3 class="text-center font-weight-bold">
			Our experts work with the most popular E-commerce platforms in the market
		</h3>	
		...
		<div class = "row text-center">
			<div class="col-sm-5">
				...
				<p>
					...
					Magento has a good security system, which is beyond SEO ready. 
				</p>
			</div>
			<div class="col-sm-7">
	...
	<div class = "container">
	  ...
	  <div class="row">
	  	<div class="col-lg-4 text-center">
	  	  	<div class = "div-corners">
	  	  		<ul>
	  	  			<li class = "div-icon"><i class="fa fa-globe"></i></li>
	  	  			<li class="h5">Web Hosting</li>
	  	  			<hr>
	  	  			<li>We help you choose the right web hosting plan and domain for your business. </li>		  	  			
	  	  		</ul>
	  	  	</div>
	  	</div>
	  	<div class="col-lg-4 text-center">
	  	  	<div class = "div-corners">
	  	  		<ul>
	  	  			<li class = "div-icon"><i class="fas fa-pen-alt"></i></li>
	  	  			<li class="h5">Content Writing</li>
	  	  			<hr>
	  	  			<li>Need to write some content on the website? Our team will help you add content keywords to your website.</li>
	  	...
	  	<div class="col-lg-4 text-center">
	  	  	<div class = "div-corners">
	  	  		<ul>
	  	  			<li class = "div-icon"><i class="fas fa-share-square"></i></li>
	  	  			<li class="h5">Digital Marketing</li>
	  	  			<hr>
	  	  			<li>
	  	  				We help you in influencing your website to the world using advertisements and social marketing methods. 
	  	  			</li>
	  ...
	  <div class="row">
  		<div class="col-lg-4 text-center">
	  	  	<div class = "div-corners">
	  	  		<ul>
	  	  			<li class = "div-icon"><i class="fas fa-hands-helping"></i></li>
	  	  			<li class="h5">24/7 Support</li>
	  	  			<hr>
	  	  			<li>
	  	...
	  	<div class="col-lg-4 text-center">
	  	  	<div class = "div-corners">
	  	  		<ul>
	  	  			<li class = "div-icon"><i class="fas fa-paint-roller"></i></li>
	  	  			<li class="h5">Maintainence</li>
	  	  			<hr>
	  	  			<li>
	  	  				We help you maintain the website and make it run smooth. 
	  	  			</li>
...
<div class="jumbotron jumbotron-fluid bg-dark-alt text-white">
	<div class = "container quote">
		<div class="row">
			<div class="col-sm-12 text-left display-4">
